...
namespace GitHub.Runner.Worker.Handlers
{
    ...
    public sealed class CompositeActionHandler : Handler, ICompositeActionHandler
    {
        ...
        public async Task RunAsync(ActionRunStage stage)
        {
            ...
            // save job defaults to be restored after the composite run


            var isJobDefaultsRunSet = ExecutionContext.Global.JobDefaults.ContainsKey("run");
            IDictionary<string, string> jobDefaultsRun = new Dictionary<string, string>();
            if (isJobDefaultsRunSet)
            {
            ...
            {
                if (isJobDefaultsRunSet && isJobDefaultsRunChanged && jobDefaultsRun != null)
                {
